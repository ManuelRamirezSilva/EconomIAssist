...
class IntentParser:
    def __init__(self):
        ...
        self.expansion_prompt = (
            ...
            "• update_cells: Actualizar celdas específicas\n"
            "• batch_update_cells: Operaciones complejas y múltiples actualizaciones\n"
            "• create_sheet: Crear nuevas pestañas\n"
            "• share_spreadsheet: Compartir hojas de cálculo\n"
            "• copy_sheet: Copiar hojas existentes\n"
            "• rename_sheet: Renombrar hojas\n"
            ...
            "• 'Anotar gasto' → list_spreadsheets + list_sheets + get_sheet_data + add_rows (agregar fila vacía) + FINAL: update_cells\n"
            "• 'Actualizar registro' → list_spreadsheets + list_sheets + get_sheet_data + add_rows (agregar fila vacía) + FINAL: update_cells\n"
            ...
            "4. Para operaciones de escritura (add_rows, update_cells): incluye navegación completa + add_rows para agregar fila vacía + update_cells para escribir datos\n"
            ...
            "Análisis: Usuario quiere REGISTRAR gasto → necesita navegación completa + agregar fila vacía en posición 2 + escribir datos\n"
            "Output: [\n"
            "  {\"intent\": \"list_spreadsheets\", \"value\": \"listar hojas de cálculo disponibles\", \"step\": \"intermedio\"},\n"
            "  {\"intent\": \"list_sheets\", \"value\": \"listar pestañas de la hoja seleccionada\", \"step\": \"intermedio\"},\n"
            "  {\"intent\": \"get_sheet_data\", \"value\": \"obtener encabezados y estructura de la hoja\", \"step\": \"intermedio\"},\n"
            "  {\"intent\": \"add_rows\", \"value\": \"agregar fila vacía para gasto 50000 pesos supermercado\", \"step\": \"intermedio\"},\n"
            "  {\"intent\": \"update_cells\", \"value\": \"registrar gasto 50000 pesos supermercado en fila 2\", \"step\": \"final\"}\n"
            "]\n"
            ...
            "  {\"intent\": \"list_sheets\", \"value\": \"listar pestañas de la hoja seleccionada\", \"step\": \"intermedio\"},\n"
            "  {\"intent\": \"get_sheet_data\", \"value\": \"obtener encabezados y estructura de la hoja\", \"step\": \"intermedio\"},\n"
            "  {\"intent\": \"add_rows\", \"value\": \"agregar fila vacía para compra dólares\", \"step\": \"intermedio\"},\n"
            "  {\"intent\": \"update_cells\", \"value\": \"registrar compra dólares en fila 2\", \"step\": \"final\"}\n"
            "]\n"
            ...
            "Input: [{\"intent\": \"add_rows\", \"value\": \"registrar deuda 30000 pesos préstamo Manuel\"}]\n"
            "Análisis: Usuario quiere REGISTRAR deuda → necesita navegación completa + agregar fila vacía específica + escribir datos\n"
            "Output: [\n"
            "  {\"intent\": \"list_spreadsheets\", \"value\": \"listar hojas de cálculo disponibles\", \"step\": \"intermedio\"},\n"
            "  {\"intent\": \"list_sheets\", \"value\": \"listar pestañas de la hoja seleccionada\", \"step\": \"intermedio\"},\n"
            "  {\"intent\": \"get_sheet_data\", \"value\": \"obtener encabezados y estructura de la hoja\", \"step\": \"intermedio\"},\n"
            "  {\"intent\": \"add_rows\", \"value\": \"agregar fila vacía para deuda 30000 pesos préstamo Manuel\", \"step\": \"intermedio\"},\n"
            "  {\"intent\": \"update_cells\", \"value\": \"registrar deuda 30000 pesos préstamo Manuel en fila 2\", \"step\": \"final\"}\n"
            "]\n"
        )
