...
#
# This module provides functions to load, chunk, embed, and query documents from the EcoData folder using a vector database (ChromaDB).
#
# Usage:
#   1. Run this script to build the vector store from EcoData PDFs.
...
DATA_PATH = os.path.join(os.path.dirname(__file__), '../../EcoData')
